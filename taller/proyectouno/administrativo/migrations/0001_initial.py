# Generated by Django 3.2.4 on 2021-06-27 05:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edificio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='num_edificio', to='administrativo.edificio')),
            ],
        ),
    ]
